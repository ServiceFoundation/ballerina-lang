...
public type Entity object {
    ...
    public extern function setByteChannel(io:ReadableByteChannel byteChannel,
    ...
    public extern function getBodyPartsAsChannel() returns @tainted io:ReadableByteChannel;
